...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    body{background: radial-gradient(1200px 600px at 10% 20%, rgba(241, 0, 76, 0.5), transparent), radial-gradient(1000px 500px at 90% 80%, rgba(255,209,102,0.03), transparent), var(--bg); color:#eee; -webkit-font-smoothing:antialiased; display:flex; align-items:center; justify-content:center; padding:32px; c1sd{width:100%; max-width:960px; background: linear-gradient(180deg, rgba(138, 4, 131, 0.5), rgba(255,255,255,0.01)); border-radius:18px; padding:28px; box-shadow: 0 10px 40px rgba(2,6,23,0.6); position:relative; overflow:hidden; border:1px solid rgba(255,255,255,0.0split  ordeordersplay:grid; split: 1fr 420px; gap:22px; align-items:center}
    @media (max-width:880px){ .split{grid-template-columns:1fr} .side{order:-margin-bottomting{padding:18px}
